...
/**
 * ViewDragHelper.Callback implementation used to work with DraggableView to
 * perform the scale effect and other animation when the view is released.
 *
...
class DraggableViewCallback extends ViewDragHelper.Callback {
    ...
    /**
     * Override method used to apply different scale and alpha effects while the
    ...
    /**
     * Override method used to apply different animations when the dragged view
     * is released. The dragged view is going to be maximized or minimized if
     * the view is above the middle of the custom view and the velocity is
    ...
    /**
     * Override method used to configure the horizontal drag. Restrict the
     * motion of the dragged child view along the horizontal axis.
     *
    ...
    /**
     * Override method used to configure the vertical drag. Restrict the motion
     * of the dragged child view along the vertical axis.
     *
     * @param child child view being dragged.
    ...
    /**
     * Maximize or minimize the DraggableView using the draggableView position
     * and the y axis velocity.
     */
    ...
    /**
     * Close the view to the right, to the left or minimize it using the
     * draggableView position and the x axis velocity.
     */
