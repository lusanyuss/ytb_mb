...
/**
 * Custom view created to handle DraggableView using fragments. With this custom
 * view the client code can configure the top and bottom fragment and other
 * elements like: top fragment height, top fragment margin right, top fragment x
 * scale factor, top fragment y scale factor, top fragment margin bottom and
 * enable or disable horizontal alpha effect.
 *
...
public class DraggablePanel extends FrameLayout {
    ...
    /**
     * Configure the FragmentManager used to attach top and bottom fragment
     * inside the view.
     */
    ...
    /**
     * Configure the Fragment that will work as draggable element inside this
     * custom view. This Fragment has to be configured before initialize the
     * view.
     *
    ...
    /**
     * Configure the Fragment that will work as secondary element inside this
     * custom view. This Fragment has to be configured before initialize the
     * view.
     *
    ...
    /**
     * Configure the height associated to the top Fragment used inside the view
     * as draggable element.
     *
    ...
    /**
     * Configure the horizontal scale factor applied when the top fragment is
     * dragged to the bottom of the custom view.
     */
    ...
    /**
     * Configure the vertical scale factor applied when the top fragment is
     * dragged to the bottom of the custom view.
     */
    ...
    /**
     * Configure the top Fragment margin right applied when the view has been
     * minimized.
     *
    ...
    /**
     * Configure the top Fragment margin bottom applied when the view has been
     * minimized.
     *
    ...
    /**
     * Configure the DraggableListener that is going to be invoked when the view
     * be minimized, maximized, closed to the left or right.
     */
    ...
    /**
     * Configure the disabling of the alpha effect applied when the view is
     * being dragged horizontally.
     *
    ...
    /**
     * Apply all the custom view configuration and inflate the main widgets. The
     * view won't be visible if this method is not called.
     * <p/>
     * FragmentManager, top Fragment and bottom Fragment have to be configured
     * before initialize this view. If not, this method will throw and
    ...
    /**
     * Validate FragmentManager configuration. If is not initialized, this
    ...
    /**
     * Validate top and bottom Fragment configuration. If are not initialized,
