...
/**
 * Transformer extension created to resize the view instead of scale it as the
 * other implementation does. This implementation is based on change the
 * LayoutParams.
 *
...
class ResizeTransformer extends Transformer {
    ...
    /**
     * @return true if the right position of the view plus the right margin is
     * equals to the parent width.
     */
    @Override
    ...
    /**
     * @return true if the bottom position of the view plus the margin right is
     * equals to the parent view height.
     */
    @Override
    ...
    /**
     * @return true if the left position of the view is to the right of the
     * seventy five percent of the parent view width.
     */
    @Override
    ...
    /**
     * @return true if the left position of the view is to the left of the
     * twenty five percent of the parent width.
     */
    @Override
