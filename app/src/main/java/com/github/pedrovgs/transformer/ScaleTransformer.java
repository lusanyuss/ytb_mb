...
/**
 * Transformer extension created to scale the view instead of resize it as the
 * other implementation does. This implementation is based on Nineoldanroids
 * library to scale the view.
 *
...
class ScaleTransformer extends Transformer {
    ...
    /**
     * @return true if the right corner of the view matches with the parent view
     * width.
     */
    @Override
    ...
    /**
     * @return true if the bottom corner of the view matches with the parent
     * view height.
     */
    @Override
    ...
    /**
     * @return true if the left position of the view is to the left of sixty
     * percent of the parent width.
     */
    @Override
    ...
    /**
     * @return true if the right position of the view is to the right of the one
     * hundred twenty five five percent of the parent view width.
     */
    @Override
