...
public class DraggableView extends RelativeLayout {
    ...
    /**
     * Clone given motion event and set specified action. This method is useful,
     * when we want to cancel event propagation in child views by sending event
     * with {@link MotionEvent#ACTION_CANCEL} action.
     *
     ...
     * configure dragged view height and to initialize DragViewHelper.
     */
    @Override
    ...
    /**
     * Initialize Transformer with a scalable or change width/height
     * implementation.
     */
    private void initializeTransformer(TypedArray attributes) {
        ...
        transformer.setXScaleFactor(attributes.getFloat(R.styleable.draggable_view_top_view_x_scale_factor,
                DEFAULT_SCALE_FACTOR));
        transformer.setYScaleFactor(attributes.getFloat(R.styleable.draggable_view_top_view_y_scale_factor,
                DEFAULT_SCALE_FACTOR));
