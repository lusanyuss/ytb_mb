...
/**
 * Internal class to automatically generate a Property for a given class/title
...
class ReflectiveProperty<T, V> extends Property<T, V> {
    ...
    /**
     * For given property title 'title', look for getName/isName method or
     * 'title' field. Also look for setName method (optional - could be
     * readonly). Failing method getters and field results in throwing
     * NoSuchPropertyException.
     *
     * @param propertyHolder The class on which the methods or field are found
     * @param title          The title of the property, where this title is capitalized and
     *                       appended to "get" and "is to search for the appropriate
     *                       methods. If the get/is methods are not found, the constructor
     *                       will search for a field with that exact title.
     */
    public ReflectiveProperty(Class<T> propertyHolder, Class<V> valueType, String name) {
        // TODO: cache reflection info for each new class/title pair
