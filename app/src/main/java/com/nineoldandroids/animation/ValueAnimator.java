...
public class ValueAnimator extends Animator {
     ...
     * animated values by property title during calls to
     ...
     * that point.
     *
     * @param playTime The time, in milliseconds, to which the animation is advanced
     *                 or rewound.
     */
     ...
     * been calculated.
     *
     * @param listener the listener to be added to the current set of listeners for
     *                 this animation.
     */
     ...
     *
     * @param value the interpolator to be used by this animation. A value of
     ...
     *
     * @param currentTime The current animation time, used to calculate whether the
