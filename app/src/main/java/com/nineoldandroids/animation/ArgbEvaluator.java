...
public class ArgbEvaluator implements TypeEvaluator {
     ...
     * @param startValue A 32-bit int value representing colors in the separate bytes
     *                   of the parameter
     * @param endValue   A 32-bit int value representing colors in the separate bytes
     *                   of the parameter
