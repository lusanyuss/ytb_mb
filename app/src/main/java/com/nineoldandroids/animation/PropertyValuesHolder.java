...
public class PropertyValuesHolder implements Cloneable {
    ...
    // These maps hold all property mList for a particular class. This map
    ...
    /**
     * The title of the property associated with the values. This need not be a
     * real property, unless this object is being used with ObjectAnimator. But
     * this is the title by which aniamted values are looked up with
     ...
     * property title.
     *
     * @param propertyName The title of the property for this holder.
     */
    ...
    /**
     * Constructs and returns a PropertyValuesHolder with a given property title
     * and set of int values.
     *
     * @param propertyName The title of the property being animated.
     ...
     * property title and set of values. These values can be of any type, but
     * the type should be consistent so that an appropriate
     ...
     *
     * @param propertyName The title of the property associated with this set of values.
     *                     This can be the actual property title to be used when using a
     *                     ObjectAnimator object, or just a title used to get animated
     ...
     *
     * @param property The property associated with this set of values. Should not be
     *                 null.
     * @param values   The set of values to animate between.
     */
    ...
    /**
     * Utility method to derive a setter/getter method title from a property
     * title, where the prefix is typically "set" or "get" and the first letter
     * of the property title is capitalized.
     *
     * @param prefix       The precursor to the method title, before the property title
     *                     begins, typically "set" or "get".
     * @param propertyName The title of the property that represents the bulk of the
     *                     method title after the prefix. The first letter of this word
     *                     will be capitalized in the resulting method title.
     * @return String the property title converted to a method title according
     * to the conventions specified above.
     */
     ...
     * what the title of the function should be and uses reflection to find the
     * Method with that title on the target object.
     *
     ...
     * property title, target object, and types of values supplied. If no getter
     ...
     * value used is whatever the value is for the property title specified in
     * the keyframe on the target object.
     *
     * @param target The target object from which the current value should be
     *               extracted.
     * @param kf     The keyframe which holds the property title and value.
     */
    ...
    /**
     * Gets the title of the property that will be animated. This title will be
     * used to derive a setter function that will be called to set animated
     * values. For example, a property title of <code>foo</code> will result in
     * a call to the function <code>setFoo()</code> on the target object. If
    ...
    /**
     * Sets the title of the property that will be animated. This title is used
     * to derive a setter function that will be called to set animated values.
     * For example, a property title of <code>foo</code> will result in a call
     * to the function <code>setFoo()</code> on the target object. If either
     * <code>valueFrom</code> or <code>valueTo</code> is null, then a getter
     * function will also be derived and called.
     * <p/>
     * <p>
     * Note that the setter function derived from this property title must take
     ...
     * ValueAnimator into a value set on the object according to the title of
     * the property.
     *
