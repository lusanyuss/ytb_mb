...
class ViewPropertyAnimatorHC extends ViewPropertyAnimator {
    ...
    private static final int TRANSFORM_MASK = TRANSLATION_X | TRANSLATION_Y | SCALE_X | SCALE_Y | ROTATION | ROTATION_X
            | ROTATION_Y | X | Y;
    /**
     ...
     * used instead.
     *
     * @param duration The length of ensuing property animations, in milliseconds.
     ...
     * stores the constant title for the property along with the from/delta
    ...
    private class AnimatorEventListener implements Animator.AnimatorListener, ValueAnimator.AnimatorUpdateListener {
         ...
         *
         * @param animation The animator associated with the properties that need to
