...
public class OnTransitionTextListener implements OnTransitionListener {
    ...
    public final OnTransitionTextListener setValueFromRes(Context context, int selectColorId, int unSelectColorId,
    ...
    public void onTransition(View view, int position, float selectPercent) {
        ...
        if (selectColor != -1 && unSelectColor != -1) {
            ...
            selectTextView.setTextColor(gradient.getColor((int) (unSelectColor * 100)));
        }
