...
public interface Indicator {
    ...
    /**
     * 设置滑动变化的转换监听，tab在切换过程中会调用此监听。<pt> 设置它可以自定义实现在滑动过程中，tab项的字体变化，颜色变化等等效果<pt>
     * 目前提供的子类
    ...
    /**
     * 设置滑动块<pt> 设置它可以自定义滑动块的样式。<pt> 目前提供的子类
     * {@link com.shizhefei.view.indicator.slidebar.ColorBar}
    ...
    /**
     * tab滑动变化的转换监听，tab在切换过程中会调用此监听。<pt> 通过它可以自定义实现在滑动过程中，tab项的字体变化，颜色变化等等效果<pt>
     * 目前提供的子类
     * {@link com.shizhefei.view.indicator.transition.OnTransitionTextListener}
     */
